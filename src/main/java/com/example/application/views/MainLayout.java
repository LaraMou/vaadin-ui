 ...
 */
@PWA(name = "vaadin-keycloak", shortName = "vaadin-keycloak", enableInstallPrompt = false)
@Theme(themeFolder = "vaadin-keycloak")
@PageTitle("Main")
public class MainLayout extends AppLayout {
    ...
    private Component createDrawerContent(Tabs menu) {
        ...
        logoLayout.add(new Image("images/logo.png", "vaadin-keycloak logo"));
        logoLayout.add(new H1("vaadin-keycloak"));
